...
public class BatchProcessing {
	...
	// try {
	// connection.setAutoCommit(false);// preparedStatement =
	// connection.prepareStatement("INSERT INTO products VALUES (?, ?, ?, ?)");
	//// // adding multiple products
	// preparedStatement.setInt(1, 1);// preparedStatement.setString(2, "Product
	// A");
	// preparedStatement.setString(3, "Description A");//
	// preparedStatement.setInt(4, 1);
	// preparedStatement.addBatch();//
	// preparedStatement.setInt(1, 2);// preparedStatement.setString(2, "Product
	// B");
	// preparedStatement.setString(3, "Description B");//
	// preparedStatement.setInt(4, 2);
	// preparedStatement.addBatch();//
	// preparedStatement.executeBatch();// connection.commit();
	// System.out.println("Batch addition of products successful.");//
	// } catch (SQLException e) {// try {
	// connection.rollback();// System.out.println("Batch addition of products
